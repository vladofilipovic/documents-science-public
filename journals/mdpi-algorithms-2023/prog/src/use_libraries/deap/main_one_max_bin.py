...
def main():
    ...
    logger.debug("  Evaluated %i individuals" % len(pop))
    ...
    logger.debug("-- End of (successfullyful) evolution --")
    
    best_ind = tools.selBest(pop, 1)[0]
    logger.debug("Best individual is %s, %s" % (best_ind, best_ind.fitness.values))
    return

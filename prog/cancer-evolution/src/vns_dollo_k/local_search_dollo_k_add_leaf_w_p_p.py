""" The :mod:`local_search_dollo_k_add_leaf_w_p_p` module contains vns
...
class LocalSearchDolloKAddLeafWPP():
    @staticmethod
    def improve_solution(solution_to_improve: DolloKSolution, alpha: float, beta: float,
        ...
        logger.debug("solution_to_improve at begin LocalSearchDolloKAddLeafWPP:" )
